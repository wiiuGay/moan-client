...
window = Tk()
window.title('moan injectorV1.11')
...
tabControl.add(tab3, text ='dont mind this')
...
# c = Checkbutton(tab2, text="pot", variable=cb6, onvalue=1, offvalue=0, command=host)
...
c = Checkbutton(tab2, text="spin punch", variable=cb18, onvalue=1, offvalue=0, command=riptideAnywhere)
c.grid(column=2, row=3)
